...
admin.site.site_header = "Abyat"
admin.site.site_title = "Abyat Admin Portal"
admin.site.index_title = "Abyat Admin"
...
schema_view = get_schema_view(
    openapi.Info(
        title="Abyat API",
        default_version="v1",
        description="API documentation for Abyat App",
    ),
    public=True,
